const data = {
  ...
  stack: {
    lang: [
      {
        url: "/images/icons/html5-original.svg",
        alt: "html",
        desc: "html",
      },
      {
        url: "/images/icons/css3-original.svg",
        alt: "css",
        desc: "css",
      },
      {
        url: "/images/icons/javascript-original.svg",
        alt: "javascripts",
        desc: "javascripts",
      },
      {
        url: "/images/icons/tailwind-css.svg",
        alt: "tailwindcss",
        desc: "tailwind css",
      },
      {
        url: "/images/icons/react-original.svg",
        alt: "reactjs",
        desc: "reactjs",
      },
      {
      ...
      {
        url: "/images/icons/mongodb-icon.svg",
        alt: "mongodb",
        desc: "mongodb",
      },
      {
        url: "/images/icons/nodejs-icon.svg",
        alt: "nodejs",
        desc: "nodejs",
      },
      {
        url: "/images/icons/expressjs-icon.svg",
        alt: "express",
        desc: "expressjs ",
      },
    ],
    tools: [
      ...
      {
        url: "/images/icons/github.svg",
        alt: "github",
        desc: "github",
      },
      {
        url: "/images/icons/icons8-firebase.svg",
        alt: "firebase",
        desc: "firebase",
      },
      {
        url: "/images/icons/postman-icon.svg",
        alt: "postman",
        desc: "postman",
      },
    ],
